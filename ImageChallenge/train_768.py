...
os.environ["CUDA_VISIBLE_DEVICES"] = Config.device_768
...
save_model_name = Config.save_model_name_768
data_dir = Config.data_dir_768
...
# 模型保存路径
save_ckpt_dir = os.path.join(Config.outmodel_dir_768, model_name, 'ckpt')
save_log_dir = os.path.join(Config.outmodel_dir_768, model_name)
...
param['epochs'] = Config.epochs_768         # 训练轮数，请和scheduler的策略对应，不然复现不出效果，对于t0=3,t_mut=2的scheduler来讲，44的时候会达到最优
param['batch_size'] = Config.batch_size_768       # 批大小
